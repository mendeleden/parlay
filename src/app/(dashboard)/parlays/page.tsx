                      ...
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="flex items-center gap-2 flex-wrap mb-1">
                              ...
                              <Badge
                                className="text-xs bg-theme-primary-100 text-theme-primary hover:bg-violet-100"
                              >
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                          {parlay.combinedDecimalOdds && (
                            <div className="hidden sm:flex items-center gap-1 px-3 py-1.5 rounded-xl bg-theme-primary-100 text-theme-primary font-bold text-sm">
                              {formatAmericanOdds(
